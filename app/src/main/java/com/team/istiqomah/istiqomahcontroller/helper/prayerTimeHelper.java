...
/**
 * Created by alde.asprilla on 08/11/2016.
 */
...
public class prayerTimeHelper {
    ...
    public prayerTimeHelper() {
        ...
        timeNames.add("FajrtimeNames");
        timeNames.add("SunrisetimeNames");
        timeNames.add("DhuhrtimeNames");
        timeNames.add("AsrtimeNames");
        timeNames.add("SunsettimeNames");
        timeNames.add("MaghribtimeNames");
        timeNames.add("Isha");
        ...
        //Setting default
        this.setTimeFormat(this.Time24); //format waktu
        this.setCalcMethod(this.Makkah); //kalulasi menurut
        this.setAsrJuristic(this.Shafii);
        this.setAdjustHighLats(this.MidNight);
        this.setTimeZone(this.getTimeZone());
        this.setFajrAngle(20);
        this.setIshaAngle(18);
